      ...
      <div className='viewMeetingsPage'>
        <div className='dateMenu'>
          ...
          <ToggleButtonGroup orientation='vertical'>
            <div >
              {allMeetings.length?allMeetings.map(meeting=>
              <ToggleButton
        ...
        <div className='meetingContents'>
          {selectedMeeting?
          <DialogTitle style={{display:'flex',flexDirection:'horizontal',justifyContent:'space-between', width:'100%', backgroundColor:'#dedede',margin: '10px', borderRadius:'10px'}}>
